  ...
  return (
    <article className="relative z-10 bg-transparent">
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        <Link
          href="/#case-studies"
          className="mb-8 inline-flex items-center text-sm font-medium text-accent-purple hover:text-accent-pink"
        >
        ...
        <h1 className="gradient-text mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
          {title}
        </h1>
        ...
        {cs?.github && (
          <a
            ...
            className="mb-8 inline-flex items-center gap-2 rounded-lg border border-white/10 px-4 py-2 text-sm font-medium text-text-secondary transition-colors hover:text-text-primary hover:border-accent-purple/40"
          >
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <Link
            href="/#case-studies"
            className="text-sm font-medium text-accent-purple hover:text-accent-pink"
          >
            &larr; Back to all projects
          </Link>
        </div>
